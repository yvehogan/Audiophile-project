    ...
    <div className="max-w-6xl m-auto">
      ...
      {category?.map((product) => (
        <div key={product.id}>
          <div className="flex justify-between gap-5 mt-20">
            ...
            <div className="w-1/2 flex flex-col justify-center items-center">
              <div className="max-w-md">
                <h5 className="tracking-widest text-Primary mb-2">
                  NEW PRODUCT
                </h5>
          ...
          <div className="flex justify-between mt-32 mb-28">
            <div className="lg:w-1/2">
              <h1 className="text-4xl font-semibold mb-7 text-black">
                FEATURES
              </h1>
          ...
          <h1 className="text-4xl flex justify-center font-semibold mt-28 mb-16">
            YOU MAY ALSO LIKE
          </h1>
